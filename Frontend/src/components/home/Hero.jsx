  ...
  return (
    <section className="relative w-full min-h-[85vh] flex items-center justify-center overflow-hidden bg-slate-50">
      ...
      <div
        ...
        style={{
          backgroundImage:
            "url('https://lh3.googleusercontent.com/aida/AP1WRLuAEBTvsv0-Y_Y6fNc2uqZuPDXE9do4wXpblKlteVelwYvj_NpWXtHvxEcO_1eUt7vb7iPQYM5WKsH8r4S8IKBmhZz1M9jJ-bFQhhruzdonMFIunH9i8Lvi1EI_lJe_6GSGQAoolKf4jn_q7PIM91dFhXVDqLxMI_RR_3OZD3KbP6a-IEnCCyDTCJQqKpCrhdZU9y4Yd8Jae2dyvU8GSxs8atuQUVq1pSNg_fBcIa9uwmVDa2knFSHktA')",
        }}
      />
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 flex flex-col lg:flex-row items-center gap-12 pt-10">
        <div className="flex-1 text-left">
          ...
          >
            Navkar Logistics provides pan-India reliable logistics solutions,
            ensuring secure and on-time delivery for all your freight needs.
          </motion.p>
          ...
          >
            <Link to="/contact" className="w-full sm:w-auto">
              <Button
                size="lg"
                className="w-full bg-[#001b3a] text-white hover:bg-[#001b3a]/90 font-semibold text-lg h-14 px-8 rounded-full shadow-lg"
              >
            ...
            <Button
              size="lg"
              variant="outline"
              className="w-full sm:w-auto bg-white text-[#001b3a] border-slate-200 hover:bg-slate-50 font-medium text-lg h-14 px-8 rounded-full shadow-sm"
            >
              <PhoneCall className="mr-2 w-5 h-5 text-[#f16322]" /> 9817764717
            </Button>
          </motion.div>
        </div>
        ...
        >
          <div className="relative rounded-2xl overflow-hidden shadow-2xl border-4 border-white">
            <img
              src="https://ik.imagekit.io/uvpva42cs/second-brain-images/ChatGPT%20Image%20Jun%204,%202026,%2009_38_58%20AM.png"
